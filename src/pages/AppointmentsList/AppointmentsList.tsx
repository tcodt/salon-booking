...
const AppointmentsList: React.FC = () => {
  ...
  return (
    <div
      className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 p-4 w-screen h-screen overflow-y-auto pb-[160px] [&::-webkit-scrollbar]:w-2
  ...
  [&::-webkit-scrollbar-thumb]:bg-transparent"
    >
      {services?.map((service, index) => (
        <div
          key={index}
          className="bg-slate-100 h-[200px] shadow-lg rounded-xl p-4 border border-transparent hover:shadow-xl transition-shadow duration-300"
        >
